  ...
  return (
    <>
      ...
      <section className="sec tight alt"><div className="inner">
        ...
        <div className="cta-row" style={{ marginTop: 24 }}><a className="btn btn-p" href="/zespol">Dołącz / zapisz się →</a><a className="btn btn-s" href="https://discord.gg/9R3RZwjPSp" rel="noopener">Discord</a></div>
      </div></section>
    </>
  );
}
