...
const MEMBERS = [
  ...
  { img: "/assets/team/piotr-zientara.jpg", name: "Piotr Zientara", specialty: "Nadworny filozof · Agenci AI · Infra LLM · Founder Xfaang", bio: "Nadworny filozof Slayera. Założyciel Xfaang. Buduje autonomicznych agentów AI i produkty LLM end-to-end u klientów. Prowadzi własny proxy modeli (LiteLLM) i agentowy harness działający 24/7 oraz narzędzia do ewaluacji i widoczności treści w wyszukiwarkach AI (GEO). Łączy produkt z inżynierią wokół modelu: dane, evale, infra.", link2: "https://xfaang.com" },
];
