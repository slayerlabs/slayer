      ...
      <section className="sec tight">
        <div className="inner">
          ...
          <div className="team-grid">
            ...
            <article className="member">
              ...
              <div className="member-info">
                ...
                <p className="member-bio"><a href="https://discord.gg/jQ3kZ7JK6M" target="_blank" rel="noopener" style={{ color: "var(--acc)" }}>Dołącz do zespołu →</a></p>
              </div>
            </article>
          </div>
          ...
          <div className="join-cta">
            ...
            <a className="btn btn-p" href="https://discord.gg/jQ3kZ7JK6M" target="_blank" rel="noopener">wejście przez Discord →</a>
          </div>
        </div>
      </section>
    </>
