...
const MEMBERS = [
  ...
  { img: null, name: "Paweł Puzio", specialty: "Architektura systemów · AWS · AI Compliance · CTO", bio: "Architekt systemów i CTO. Rozwija rozwiązania AI do automatyzacji procesów compliance w branży AEC. Łączy LLM-y, architekturę AWS i klasyczne podejście inżynierskie — skupia się na jakości wyników, niezawodności i praktycznych zastosowaniach AI w codziennej pracy specjalistów." },
