...
const lemCss = `
  ...
  /* mobile nav (pure-CSS hamburger) — base/desktop: burger hidden, links shown inline */
  .lem-nav-toggle { position: absolute; opacity: 0; width: 1px; height: 1px; pointer-events: none; }
  .lem-nav-burger { display: none; width: 42px; height: 42px; border: 1px solid #c8cbdc; border-radius: 8px; cursor: pointer; align-items: center; justify-content: center; color: #3f4154; background: rgba(255,255,255,.5); }
  .lem-nav-burger::before { content: "\\2630"; font-size: 18px; line-height: 1; }
  .lem-nav-toggle:checked ~ .lem-nav-burger::before { content: "\\2715"; }

  /* mobile responsive pass — these rules only render on the homepage route */
  @media (max-width: 760px) {
    /* hamburger: show toggle, links become a dropdown panel under the bar */
    .lem-nav-burger { display: inline-flex; }
    .lem-nav-links { display: none !important; flex-basis: 100%; order: 3; flex-direction: column; align-items: flex-start !important; gap: 2px !important; padding: 6px 0 2px; }
    .lem-nav-links a { padding: 9px 2px; }
    .lem-nav-toggle:checked ~ .lem-nav-links { display: flex !important; }

    /* tame the 40px side padding on every section at once */
    [style*="margin: 0 auto"] { padding-left: 20px !important; padding-right: 20px !important; }

    /* scale the big headings (hero h1 is already fluid via inline clamp) */
    h2 { font-size: clamp(26px, 6.8vw, 38px) !important; }

    /* stack text / comparison grids into one column */
    [style*="grid-template-columns: 1fr 1fr"]:not(.lem-carousel),
    [style*="grid-template-columns: 360px 1fr"],
    [style*="grid-template-columns: 1.1fr 1fr"],
    [style*="grid-template-columns: 250px 1fr 1fr"] { grid-template-columns: 1fr !important; }

    /* independent-tile sections → swipeable scroll-snap carousel */
    .lem-carousel { display: flex !important; flex-direction: row !important; grid-template-columns: none !important; overflow-x: auto; scroll-snap-type: x mandatory; gap: 14px !important; padding-bottom: 10px; -webkit-overflow-scrolling: touch; }
    .lem-carousel > * { flex: 0 0 86% !important; scroll-snap-align: start; }
    .lem-carousel::-webkit-scrollbar { height: 6px; }
    .lem-carousel::-webkit-scrollbar-thumb { background: #c8cbdc; border-radius: 3px; }

    /* ledger table → contained horizontal scroll instead of page overflow */
    .lem-ledger { overflow-x: auto !important; -webkit-overflow-scrolling: touch; }
    .lem-ledger > div { min-width: 720px; }
  }
`;
...
const html = `<div style="min-height: 100vh; background: #eceef6; color: #2a2b38; font-family: 'IBM Plex Sans', sans-serif;">
  ...
  <div style="border-bottom: 1px solid #e0e2ee; background: rgba(236,238,246,.85);">
    <div style="max-width: 1120px; margin: 0 auto; padding: 18px 40px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px 20px;">
      ...
      <input type="checkbox" id="lem-nav" class="lem-nav-toggle" aria-hidden="true">
      <label for="lem-nav" class="lem-nav-burger" role="button" aria-label="Menu"></label>
      <div class="lem-nav-links" style="display: flex; align-items: center; gap: 26px; font-family: 'IBM Plex Mono', monospace; font-size: 12.5px; color: #6a6f86;">
        <a href="/rules">protokół</a><a href="/eksperymenty">księga pomiarów</a><a href="/drabina">drabina</a><a href="/benchmarks">artefakty</a>
        <a href="https://discord.gg/9R3RZwjPSp" target="_blank" rel="noopener" style="background: #ef8a6e; color: #fff; padding: 8px 16px; border-radius: 40px; font-weight: 500;">wejdź do labu →</a>
      </div>
    </div>
  </div>
  ...
  <div style="border-bottom: 1px solid #e0e2ee; background-image: linear-gradient(rgba(123,132,212,.06) 1px, transparent 1px), linear-gradient(90deg, rgba(123,132,212,.06) 1px, transparent 1px); background-size: 44px 44px;">
    <div style="max-width: 1120px; margin: 0 auto; padding: 88px 40px 76px;">
      ...
      <h1 style="font-family: 'Space Grotesk', sans-serif; font-weight: 600; font-size: clamp(36px, 8.5vw, 76px); line-height: 1.05; letter-spacing: -.03em; margin: 0 0 30px; max-width: 980px; color: #232430;">Protokół dla polskiej <span style="font-family: 'Newsreader', serif; font-style: italic; font-weight: 500; color: #5a63c0;">inteligencji</span>.</h1>
      ...
      <div style="display: flex; gap: 14px; align-items: center; flex-wrap: wrap;">
        <a href="https://discord.gg/9R3RZwjPSp" target="_blank" rel="noopener" style="background: #ef8a6e; color: #fff; font-weight: 600; padding: 15px 26px; border-radius: 40px; font-size: 15px;">Wejdź do labu →</a>
  ...
  <div style="border-bottom: 1px solid #e0e2ee; background: #e6e8f3;">
    <div style="max-width: 1120px; margin: 0 auto; padding: 56px 40px 64px;">
      ...
      <div class="lem-ledger" style="border: 1px solid #d6d9ea; border-radius: 6px; overflow: hidden; background: #f6f7fc; font-family: 'IBM Plex Mono', monospace;">
  ...
  <div style="border-bottom: 1px solid #e0e2ee; background: #f4f5fa;">
    <div style="max-width: 1120px; margin: 0 auto; padding: 80px 40px;">
      <div class="lem-carousel" style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
  ...
  <div style="border-bottom: 1px solid #e0e2ee; background: #f4f5fa;">
    <div style="max-width: 1120px; margin: 0 auto; padding: 84px 40px;">
      ...
      <div class="lem-carousel" style="display: flex; flex-direction: column; gap: 14px;">
  ...
  <div style="background: #ef8a6e;">
    <div style="max-width: 1120px; margin: 0 auto; padding: 88px 40px; text-align: center;">
      ...
      <div style="display: flex; gap: 14px; justify-content: center; flex-wrap: wrap;">
        <a href="https://discord.gg/9R3RZwjPSp" target="_blank" rel="noopener" style="background: #3a160b; color: #fff; font-weight: 600; padding: 15px 30px; border-radius: 40px; font-size: 15px;">Wejście do labu (Discord) →</a>
  ...
  <div style="background: #232430; color: #b9bccd;">
    <div style="max-width: 1120px; margin: 0 auto; padding: 44px 40px; display: flex; align-items: flex-start; justify-content: space-between; gap: 24px; flex-wrap: wrap;">
      ...
      <div style="font-family: 'IBM Plex Mono', monospace; font-size: 12px; color: #8b8fa8; display: flex; gap: 28px; flex-wrap: wrap;">
        <a href="https://github.com/slayerlabs" target="_blank" rel="noopener">GitHub: lem-protocol</a><a href="/eksperymenty">księga pomiarów</a><a href="/drabina">drabina</a><a href="/roadmap">roadmap</a><a href="https://discord.gg/9R3RZwjPSp" target="_blank" rel="noopener">discord</a><a href="https://ort.fabryka.ai" target="_blank" rel="noopener">wczesne badania</a>
      </div>
    </div>
  </div>
